...
public class Moba_Camera : MonoBehaviour
{
    ...
    void CalculateCameraMovement()
    {
        ...
        if (Input.GetKeyDown(this.inputs.keycodes.CameraMoveBackward) ||
            Input.GetKeyDown(this.inputs.keycodes.CameraMoveForward) ||
            Input.GetKeyDown(this.inputs.keycodes.CameraMoveLeft) ||
            Input.GetKeyDown(this.inputs.keycodes.CameraMoveRight))
        {
            this.settings.cameraLocked = false;
        }
